...
public class TopologyArgs implements Serializable {
  ...
  @Option(name = "-sf", aliases = "--shuffler", metaVar = "<num>",
    usage = "# shufflers [def:2]")
  public int numShufflers = 1;

  @Option(name = "-dp", aliases = "--dispatcher", metaVar = "<num>",
    usage = "# dispatchers [def:4]")
  public int numDispatcher = 2;

  @Option(name = "-pr", aliases = "--part-r", metaVar = "<num>",
    usage = "# partitions of relation R [def:4]")
  public int numPartitionsR = 5;

  @Option(name = "-ps", aliases = "--part-s", metaVar = "<num>",
    usage = "# partitions of relation S [def:4]")
  public int numPartitionsS = 5;

  @Option(name = "-pt", aliases = "--part-t", metaVar = "<num>",
  ...
  @Option(name = "-cd", aliases = "--checkDuplicate", usage = "enable check duplicate [def:false]")
  public Boolean checkDuplicate = false;

  @Option(name = "-ba", aliases = "--barrier-enable", usage = "enable barrier [def:false]")
  public Boolean barrierEnable = false;

  @Option(name = "--barrier-period", metaVar = "<num>",
    usage = "barrier period from dispatcher in ms [def:10]")
  public int barrierPeriod = 1;
  ...
  public String groupId = "BiStream";
  ...
  @Option(name = "--rate", metaVar = "<num>", usage = "input rate [def: 10000]")
  public int rate = 5;
  ...
  @Option(name = "-wl", aliases = "--window-length", metaVar = "<num>",
    usage =  "join window length in ms [def:" + "10"
      + "]")
  public int windowLength = 1000;
  ...
  private void sanityCheckArgs() {
    ...
    checkState(numPartitionsT > 0, "At least one partition S is required");
